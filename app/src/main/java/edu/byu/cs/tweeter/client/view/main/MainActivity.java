...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                presenter.unFollow(followButton.getText().toString().equals(v.getContext().getString(R.string.following)), selectedUser);
            }
        });
    }
    ...
    @Override
    public void enableFollowButton(boolean setEnabled) {
        followButton.setEnabled(setEnabled);
    }
    ...
    @Override
    public void displayLogOutToast(String message) {
        logOutToast = Toast.makeText(this, message, Toast.LENGTH_LONG);
        logOutToast.show();
    }

    @Override
    public void displayPostingToast(String message) {
